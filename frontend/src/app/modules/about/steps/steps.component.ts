  ...
  ngOnInit(): void {
    this.stepCardData = [
      ...
      },
      {
        ...
        description: ` We'll help you negotiate the best terms and prepare your offer. Our goal is to secure the property at the right price and on favorable terms. We want you to be fully informed.`,
      },
    ];
  }
}
