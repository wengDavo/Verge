    ...
    <section class="grid gap-4">
      <article class="grid gap-4 md:flex md:items-center ">
        ...
        <div class="flex gap-1 text-sm md:grow">
          <p class="p-2 border dark:border-grey-15 border-white-85 rounded-md flex items-center">
      ...
      <figure class="p-5 grid gap-5 dark:bg-grey-10 bg-white-90 border dark:border-grey-15 border-white-95 rounded-lg place-content-center">
        ...
        <div class="flex overflow-scroll gap-3 no-scrollbar h-16 dark:bg-grey-8 bg-white-85 border dark:border-grey-15 border-white-95 p-3 rounded-md md:order-1">
        ...
        <div class="flex dark:bg-grey-8 bg-white-85 p-2 rounded-[100px] items-center justify-between md:order-3 md:w-52 md:mx-auto">
          <p class="p-2 dark:bg-grey-10 bg-white-90 border dark:border-grey-15 border-white-95 rounded-full grid place-content-center">
