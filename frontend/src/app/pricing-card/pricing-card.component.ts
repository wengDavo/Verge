...
@Component({
  ...
  template: `
    <article class="rounded-xl p-5 border dark:border-grey-15 border-white-85 md:rounded-md">
      <div class="flex items-center">
        <p class="grow">{{ data.title }}</p>
        <button class="border dark:border-grey-10 border-white-85 px-5 py-3 rounded-lg">
          Learn More
        </button>
      </div>
