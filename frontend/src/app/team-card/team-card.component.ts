...
@Component({
  ...
  template: `
    <article class='p-5 border border-grey-15 bg-red-400b relative rounded-xl w-fit mt-2'>
      ...
      <div class="space-y-4">
        ...
        <div class="py-2 px-6 leading-3 flex justify-between rounded-[100px] bg-grey-10 border border-grey-15">
